...
public class Receiver {
    ...
    Receiver() throws NoSuchPaddingException, NoSuchAlgorithmException {
    ...
    public void receive_packet(byte[] arr) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        this.valid = false;
    ...
    private byte[] decrypt_text() throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        ByteBuffer buffer = ByteBuffer.wrap(this.packet_as_bytes);
        ...
        byte[] temp = this.cipher.doFinal(str_as_bytes);
        return temp/*this.cipher.doFinal(str_as_bytes)*/;
    }
