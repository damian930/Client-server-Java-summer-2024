...
public class Sender {
    ...
    public void create_packet(int command_code, int user_id, String plain_text, byte client_application_number) throws IllegalBlockSizeException, BadPaddingException {
